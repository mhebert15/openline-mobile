...
export const mockMeetings: Meeting[] = [
  ...
  },
  {
    ...
    medical_rep_id: 'user-1',
    office_id: 'office-3',
    scheduled_at: new Date('2025-11-18T09:30:00').toISOString(),
    duration_minutes: 45,
    status: 'scheduled',
    notes: 'Strategy session for Q4 initiatives',
  ...
  },
  {
    ...
    medical_rep_id: 'user-1',
    office_id: 'office-4',
    scheduled_at: new Date('2025-12-02T13:00:00').toISOString(),
    duration_minutes: 30,
    status: 'scheduled',
    notes: 'Holiday planning and sample drop-off',
...
export const mockAvailableSlots = {
  'office-1': [
    { time: '08:30', available: true, preferred: true, clinicianCount: 2 },
    { time: '09:00', available: true, preferred: true, clinicianCount: 1 },
    { time: '09:30', available: true, preferred: true, clinicianCount: 1 },
    { time: '10:00', available: false, preferred: true, clinicianCount: 0 },
    { time: '11:00', available: true, clinicianCount: 2 },
    { time: '13:00', available: true, clinicianCount: 1 },
    { time: '14:30', available: true, clinicianCount: 1 },
    { time: '15:00', available: true, clinicianCount: 1 },
    { time: '15:30', available: false, clinicianCount: 0 },
    { time: '16:30', available: true, clinicianCount: 1 },
  ],
  'office-2': [
    { time: '08:00', available: true, preferred: true, clinicianCount: 1 },
    { time: '08:30', available: true, preferred: true, clinicianCount: 2 },
    { time: '09:00', available: false, preferred: true, clinicianCount: 0 },
    { time: '11:30', available: true, clinicianCount: 1 },
    { time: '12:00', available: true, clinicianCount: 1 },
    { time: '13:00', available: true, clinicianCount: 2 },
    { time: '14:30', available: false, clinicianCount: 0 },
    { time: '15:00', available: true, clinicianCount: 1 },
    { time: '16:30', available: true, clinicianCount: 1 },
  ],
};
